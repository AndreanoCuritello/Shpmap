package ru.r8digitaltech7.onlylemi.mapview.library.utils;
...
import ru.r8digitaltech7.onlylemi.mapview.library.utils.math.FloydAlgorithm;
import ru.r8digitaltech7.onlylemi.mapview.library.utils.math.GeneticAlgorithm;
import ru.r8digitaltech7.onlylemi.mapview.library.utils.math.TSPNearestNeighbour;
...
public final class MapMath {
    ...
    public static List<Integer> getBestPathBetweenPointsByGeneticAlgorithm(float[][] matrix) {
        ...
        List<Integer> result = new ArrayList<Integer>(best.length);
