...
public class GeneticAlgorithm {
    ...
    private static final float DEFAULT_CROSSOVER_PROBABILITY = 0.9f; // �?认交叉概率
    private static final float DEFAULT_MUTATION_PROBABILITY = 0.01f; // �?认突�?概率
    private static final int DEFAULT_POPULATION_SIZE = 30; // �?认种群数量
    private static final int PREVIOUS = 0;
    private static final int NEXT = 1;

    private float crossoverProbability = DEFAULT_CROSSOVER_PROBABILITY; // 交叉概率
    private float mutationProbability = DEFAULT_MUTATION_PROBABILITY; // 突�?概率

    private int populationSize = DEFAULT_POPULATION_SIZE; // 种群数量
    private int mutationTimes = 0; // �?异次数
    ...
    private void selection() {
        ...
        parents[1] = exchangeMutate(bestIndivial.clone()); // 对最好的个体进行交换�?异
        parents[2] = insertMutate(bestIndivial.clone()); // 对最好的个体进行插入�?异
